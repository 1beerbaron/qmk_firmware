...
[_NUM] = LAYOUT(
	        ...
	        KC_LGUI,	    KC_LALT,      KC_LEFT_SHIFT,      KC_LCTL,      KC_NO,                      KC_ASTR,    KC_4,   KC_5,   KC_6,   KC_PLUS,
...
[_SYM] = LAYOUT(
	        ...
	        KC_UNDERSCORE,  KC_DOLLAR,  KC_PIPE,        KC_HASH,        KC_BACKSLASH,                       KC_NO,      KC_LCTL,      KC_LSFT,  KC_LALT,  KC_LGUI,
...
[_COMBO] = LAYOUT(
	        ...
	        KC_LGUI,  KC_LALT,  KC_LEFT_SHIFT,      KC_LCTL,      KC_NO,                  KC_NO,          LCTL(KC_A),             LCTL(KC_X),     LCTL(KC_C),     LCTL(KC_V),
...
[_FUNC] =  LAYOUT(
	        ...
	        KC_LGUI,    KC_LALT,    KC_LEFT_SHIFT,    KC_LCTL,    KC_NO,                      KC_NO,	KC_F5,  KC_F6,  KC_F7,  KC_F8,
