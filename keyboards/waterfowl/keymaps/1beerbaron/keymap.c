...
const uint16_t PROGMEM LAYER_COMBO[] = {KC_BACKSPACE, KC_E, COMBO_END};
const uint16_t PROGMEM LAYER_NUM[] = {KC_E, KC_TAB, COMBO_END};
const uint16_t PROGMEM LAYER_SYM[] = {KC_ENTER, KC_SPACE, COMBO_END};
const uint16_t PROGMEM LAYER_NAV[] = {KC_SPACE, KC_DELETE, COMBO_END};
combo_t key_combos[] = {
...
[_BASE] = LAYOUT(
	    ...
	    MT(MOD_LGUI, KC_R), MT(MOD_LALT, KC_S), MT(MOD_LSFT, KC_T),	MT(MOD_LCTL, KC_H),	KC_P,                               KC_W,       MT(MOD_LCTL, KC_N), MT(MOD_LSFT, KC_A), MT(MOD_LALT, KC_I),	MT(MOD_LGUI, KC_O),
	    KC_QUESTION,        KC_V,				KC_G,				KC_D,				KC_B,                               KC_X,	    KC_M,				KC_DOT,			    KC_SEMICOLON,		KC_QUOTE,
	KC_NO,                                      KC_BACKSPACE,		KC_E,               KC_TAB, MO(_FUNC),  KC_AUDIO_MUTE,  KC_ENTER,   KC_SPACE,			KC_DELETE,		                                            KC_HOME
),
...
[_NUM] = LAYOUT(
	        ...
	        KC_NO,	    KC_NO,      KC_NO,      KC_NO,      KC_NO,                      KC_ASTR,    KC_4,   KC_5,   KC_6,   KC_PLUS,
	        KC_NO,	    KC_NO,      KC_NO,      KC_NO,      KC_NO,				        KC_SLSH,    KC_1,   KC_2,   KC_3,   KC_MINS,
	KC_NO,	                        KC_NO,      KC_TRNS,    KC_TRNS,    KC_NO,  KC_NO,  KC_ENTER,	KC_0,   KC_DOT,                     KC_NO
),
...
[_SYM] = LAYOUT(
	        ...
	        KC_UNDERSCORE,  KC_DOLLAR,  KC_PIPE,    KC_HASH,        KC_BACKSLASH,                   KC_NO,      KC_CIRCUMFLEX,  KC_EXCLAIM, KC_TILD,    KC_TILDE,
	        KC_AT,          KC_PERCENT, KC_EQUAL,   KC_AMPERSAND,   KC_SLASH,                       KC_NO,      KC_NO,          KC_NO,      KC_NO,      KC_NO,
	KC_1,                               TD_BRACKET, TD_PAREN,       TD_CURLY_BRACE, KC_NO,  KC_NO,  KC_TRNS,    KC_TRNS,        KC_NO,                          KC_NO
),
...
[_NAV] = LAYOUT(
	        ...
	        KC_LEFT,	KC_DOWN,        KC_UP,      KC_RGHT,    KC_NO,                  KC_NO,  KC_LCTL,    KC_LSFT,    KC_LALT,    KC_LGUI,
	        KC_NO,		KC_NO,          KC_NO,      KC_NO,      KC_NO,                  KC_NO,  KC_NO,      KC_NO,      KC_NO,      KC_NO,
...
[_COMBO] = LAYOUT(
	        ...
	        KC_NO,  KC_NO,  KC_NO,      KC_NO,      KC_NO,                  KC_NO,          LCTL(KC_A),             LCTL(KC_X),     LCTL(KC_C),     LCTL(KC_V),
	        KC_NO,  KC_NO,  KC_NO,      KC_NO,      KC_NO,                  KC_NO,          LCTL(KC_Z),             LCTL(KC_Y),     KC_INSERT,      RCS(KC_ESC),
	KC_NO,                  KC_TRNS,    KC_TRNS,	KC_NO,  KC_NO,  KC_NO,  RCS(KC_ENTER),  KC_PRINT_SCREEN,        LGUI(KC_R),                                   KC_NO
),
